...
const file_metadata_metadata_proto_rawDesc = "" +
	...
	"\rfile_desc_set\x18\x01 \x01(\v2\".google.protobuf.FileDescriptorSetR\vfileDescSet2\xdd\x01\n" +
	"\bMetadata\x12a\n" +
	...
	"\x0eGetServiceDesc\x12!.kratos.api.GetServiceDescRequest\x1a\x1f.kratos.api.GetServiceDescReply\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/services/{name}Bc\n" +
	"\x15com.github.kratos.apiP\x01Z<github.com/go-kratos/kratos/v2/api/proto/kratos/api;metadata\xa2\x02\tKratosAPIb\x06proto3"
